...
class AddingRefund extends Component {
  ...
  componentWillReceiveProps = (nextProps) => {
    const alertMessage =
      ...
      (nextProps.refundErrors && toast.error('Wibeshye numero cyangwa nturishyura icyo gicuruzwa'));
              ...
              <form className='form-group' onSubmit={this.handleSubmit}>
                <div className='form-row'>
                  <div className='col-md-12'>
                    <label className='small mb-1'>Numero yicyatumijwe</label>
                    <input
                      type='number'
                      name='refundOrder'
                      className='form-control py-4'
                      placeholder='Shyiramo numero watumiyeho'
                      onChange={this.refundOrderChange}
                    ></input>
                  </div>
                  <div className='col-md-12'>
                    <label className='small mb-1'>Impamvu</label>
                    <textarea
                      rows='4'
                      cols='20'
                      name='description'
                      className='form-control py-4'
                      placeholder='Shyiramo impamvu yo gusubizwa'
