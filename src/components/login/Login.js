...
class Login extends Component {
  ...
  componentWillReceiveProps = (nextProps) => {
    const alertMessage =
      nextProps.loginErrors && toast.error('Imeri cyangwa ijambo ryibanga ntabwo aribyo');
          ...
          <div>
            <div className='form'>
              ...
              <div className='header'>
                <h3 className='text-center font-weight-light my-4'>Injira</h3>
              </div>
              <div className='body'>
                <form className='form-group' onSubmit={this.handleSubmit}>
                  ...
                  <div className='form-group'>
                    <button className='btn btn-secondary'>Injira</button>
                  </div>
                </form>
              </div>
              <div className='footer'>
                <Link to='/signup'>Ukeneye konti? Iyandikishe!</Link>
              </div>
            </div>
          </div>
        </div>
