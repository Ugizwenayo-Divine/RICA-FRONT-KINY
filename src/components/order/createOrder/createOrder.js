            ...
            <div className='card-body col-md-offset-3' style={{height:'auto'}}>
              ...
              <div className='card-field'>
                <div className='col-md-9'>
                    <label className='large mb-1'>Igicuruzwa</label>
                    <input
                      name='product'
                  ...
                  <div className='col-md-9'>
                    <label className='large mb-1'>Igiciro</label>
                    <input
                      name='price'
                      className='form-control py-2'
                      value={product.price}
                  ...
                  <div className='col-md-9'>
                    <label className='large mb-1'>Ingano</label>
                    <input
                      name='quantity'
                      className='form-control py-2'
                  ...
                  <div className='col-md-9'>
                    <label className='large mb-1'>Aho utuye</label>
                    <input
                      name='quantity'
                      className='form-control py-2'
                      placeholder='Shyiramo izina ryaho utuye'
