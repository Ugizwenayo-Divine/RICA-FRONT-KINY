...
class LandingHeader extends Component {
  ...
  componentWillReceiveProps = (nextProps) => {
    ...
    alertMessage =
      nextProps.searchErrors && toast.error('Igicuruzwa ntikibonetse');
        ...
        <div className='grid-container'>
          ...
          <div className='grid-item search'>
            <form className='search-form' onSubmit={this.handleEnterPress}>
              <span className='all'>
                <span onClick={this.handleSubmitAll}>BYOSE</span>
          ...
          {!localToken ? (
            <div className='grid-item'>
              <Link to='/signup'>Kwiyandikisha | </Link>
              <Link to='/login'>Injira</Link>
            </div>
          ) : (
            <div className='grid-item'>
              <Link to='/displayclientorders'> Ibyatumijwe &nbsp;&nbsp;</Link>
          ...
          <div className='grid-item navbar'>
            ...
            {this.state.loggedInUser ? (
              this.state.loggedInUser.type === 'admin' ? (
                <Link to='/addproduct'>Umuyobozi</Link>
              ) : null
            ) : null}
            <DropDown
